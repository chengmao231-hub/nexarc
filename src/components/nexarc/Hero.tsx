        ...
        <div>
          <motion.div variants={fadeUp} custom={0} initial="hidden" animate="show">
            <span className="clip-hud inline-flex items-center gap-2 border border-arc/50 bg-arc/12 px-4 py-2">
              ...
              <span className="hud-label text-[0.6rem] text-arc-bright">Built on ARC</span>
            </span>
          </motion.div>
          ...
          >
            <span className="block text-foreground">The Next</span>
            <span className="block text-foreground">Meme on</span>
            <span className="glow-text block text-arc-bright">ARC</span>
          </motion.h1>
          ...
          >
            NEXARC is a community-driven memecoin built on ARC, bringing meme culture,
            creativity and community energy to the next chapter of the ecosystem.
          </motion.p>
          ...
          >
            ...
            <GhostButton href={LINKS.telegram} target="_blank" rel="noopener noreferrer" aria-label="Join NEXARC on Telegram">
              <TelegramIcon className="h-4 w-4" /> Join Telegram
            </GhostButton>
          ...
          >
            <span className="hud-label text-[0.58rem] text-muted-foreground">Contract</span>
